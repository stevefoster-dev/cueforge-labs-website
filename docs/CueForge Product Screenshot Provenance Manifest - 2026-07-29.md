...
| `images/app-screenshots/cuepack/truck-pack-3d-populated.webp` | `TruckPack3D` → `PackView` → `TruckScene`; separate synthetic pack at `06d9f96…` | `c96936bd356ea6cf08254f424ddf45e380530c9911231c43f1066f84d2a9f3de` | Group-aware 3D pack shown as a human-reviewed draft, not a legal load inspection. |
